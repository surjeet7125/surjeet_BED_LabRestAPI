...
<body>
	<div class="container">
		...
		<hr>
		<!-- Add a search form -->
		<form action="/CustomerRelationalManagement/customer/search" class="form-inline">
			<!-- Add a button -->
				...
				<c:forEach items="${Customer}" var="tempCustomer">
					<tr>
						...
						<td>
							...
							href="/CustomerRelationalManagement/customer/showFormForUpdate?customerId=${tempCustomer.id}"
